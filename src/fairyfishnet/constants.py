...
ABORT_REASON_VARIANTS_UNAVAILABLE = "variants_unavailable"
...
# Networks may exist for server-defined variants as well as engine built-ins.
# Keep this list independent from startup engine capability validation.
nnue_variants = required_engine_variants | {
    "cannonshogi",
    "chak",
    "chennis",
    "empire",
